...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-6">
      <p className="text-sm">
        {/* Estudante de Engenharia de Controle e Automação no IFES com foco em 
        Engenharia de Dados. Especializado em desenvolver pipelines de dados robustos, 
        automatizar processos e otimizar fluxos de informações utilizando Python, SQL, 
        Databricks e ferramentas modernas. Apaixonado por transformar dados complexos 
        em soluções que geram valor e facilitam decisões estratégicas. */}
        Transformando dados brutos em inteligência estratégica. Especialista em construir pipelines robustos e escaláveis.
      </p>
